...
export default function AsientoListPrevCaja() {
  //Previos por contabilizar Contados y Creditos
  //se ejecutaran proc almacenados, similar al Generador de asientos masivo
