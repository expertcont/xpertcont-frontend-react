...
export default function AsientoList() {
  ...
  useEffect( ()=> {
      ...
      console.log("2do useeffect st_valorVista : ",st_valorVista);
      if (st_valorVista===null || st_valorVista===undefined || st_valorVista===''){
      cargaPermisosMenuComando('01'); //Por default, la 1era vez
      setValorVista('ventas'); //Por default, la 1era vez
      console.log("forzando en 2do useeffect para obligar a tercero  cargar comandos");      
      }else{
      setValorVista(st_valorVista);
      }
      ...
      /*console.log('pVenta0102 cargado: ',pVenta0102);
      console.log('pCompra0202 cargado: ',pCompra0202);
